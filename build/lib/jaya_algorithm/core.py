...
class JayaOptimizer:
    ...
    def optimize(self):
        ...
        for iteration in range(self.max_iterations):
            ...
            # Track the best objective function value
            convergence_history.append(fitness[best_index])

            # Early stopping if convergence is achieved
            if iteration > 1 and convergence_history[-1] == convergence_history[-2]:
                break

        return best_solution, self.function(best_solution), convergence_history
